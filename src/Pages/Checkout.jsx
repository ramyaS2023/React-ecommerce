          ...
          <div className='border p-2 mb-4'>
            ...
            <div className={`space-y-4 ${billingToggle ? "" : "hidden"}`}>
              ...
              <div>
                ...
                <input type="number" name='phone' placeholder='Enter Phone #' className='w-full px-3 py-2 border'/>
              </div>
            </div>
          </div>
          ...
          <div className='border p-2 mb-4'>
            ...
            <div className={`space-y-4 ${shippingToggle ? "" : "hidden"}`}>
              ...
              <div>
                ...
                <input type="text" name='city' placeholder='Enter Email' className='w-full px-3 py-2 border' onChange={(e) =>setShippingInfo({...shippingInfo, city: e.target.value})}/>
              </div>
              <div>
                <label className='block text-gray-700'>Zip-code</label>
                <input type="number" name='zip' placeholder='Enter Phone #' className='w-full px-3 py-2 border' onChange={(e) =>setShippingInfo({...shippingInfo, zip: e.target.value})}/>
              </div>
            </div>
          </div>
        {/* Payment Method */}
